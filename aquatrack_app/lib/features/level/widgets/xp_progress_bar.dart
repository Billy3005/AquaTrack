...
class _LevelBadge extends StatelessWidget {
  ...
  const _LevelBadge({required this.level, required this.isAnimating});
  ...
  Widget build(BuildContext context) {
    return Container(
          ...
          decoration: BoxDecoration(
            gradient: LinearGradient(
              colors: isAnimating
                  ...
                  : [
                      AppColors.xpPurple.withValues(alpha: 0.8),
                      AppColors.xpPurple,
                    ],
              begin: Alignment.topLeft,
              end: Alignment.bottomRight,
          ...
          child: Row(
            ...
            children: [
              const Icon(Icons.stars, color: AppColors.textPrimary, size: 18),
