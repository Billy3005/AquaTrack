    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ fontSize: 11, color: COLORS.textMuted }}>Hold để rót dài</div>
        </div>
...
function BottomTabBar({ active, onNavigate }) {
  const tabs = [
    { id: 'home', label: 'Drop', svg: (c) => I.drop(c, 22) },
    { id: 'coach', label: 'Coach', svg: (c) => (
    ...
    { id: 'eco', label: 'Body', svg: (c) => (
      <svg width="22" height="22" viewBox="0 0 24 24" fill={c}>
        <circle cx="12" cy="5" r="2.5"/>
        <path d="M9 9 H15 V14 H14 V20 H10 V14 H9 z"/>
      </svg>
    )},
    { id: 'stats', label: 'Stats', svg: (c) => (
    ...
    { id: 'friends', label: 'Friends', svg: (c) => (
      <svg width="22" height="22" viewBox="0 0 24 24" fill={c}>
    ...
    { id: 'level', label: 'Level', svg: (c) => I.trophy(c, 22) },
    { id: 'profile', label: 'You', svg: (c) => (
      <svg width="22" height="22" viewBox="0 0 24 24" fill={c}>
