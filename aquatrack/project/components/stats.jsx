    ...
    <div style={{
      ...
      <div style={{ padding: '54px 20px 0' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 14 }}>
          <div>
            <div style={{ fontSize: 11, color: COLORS.textBright, fontWeight: 600, letterSpacing: '0.1em', textTransform: 'uppercase', fontFamily: FONT_TEXT }}>LỊCH SỬ
          ...
          <CoinBadge amount={1240} compact suffix="stats" onClick={() => onNavigate && onNavigate('shop')} />
          {/* Period toggle */}
          <div style={{
      ...
      <div style={{ flex: 1, overflow: 'auto', padding: '0 16px 20px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 8, marginBottom: 18 }}>
          <Metric value="84%" label="đạt mục tiêu" accent="#38BDF8" />
          <Metric value="12" label="ngày streak" accent="#F97316" suffix="🔥" />
          <Metric value="14.7L" label="tuần này" accent="#A78BFA" />
        </div>
...
function WaveChart({ days }) {
  ...
  return (
    <svg width="100%" height={H} viewBox={`0 0 ${W} ${H}`} style={{ display: 'block' }}>
      ...
      <text x={W - P} y={goalY - 4} textAnchor="end" fontSize="9" fill="rgba(56,189,248,0.7)" fontFamily="-apple-system">Mục tiêu 100%</text>
